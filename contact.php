...
<head>
	...
	<title>DearJob - Contact Us</title>
    ...
    <meta property="og:image:alt" content="DearJob" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> Anand, <br/> Gujarat, <br/>India</address>
								</li>
								<li>
										<h5>Email</h5><a href="dearjob.portal@gmail.com">dearjob.portal@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+917874916046">+91 7874916046</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About DearJob</h5>
											<p>DearJob is a job portal, online job management system developed by sumit , krunal and rudra for his project in 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">DearJobs Contact</h5>
								
								<p>Address : Anand, Gujarat, India.</p>
								<p>Email : <a href="mailto:dearjob.portal@gmail.com">dearjob.portal@gmail.com</a></p>
								<p>Phone : <a href="tel:+917874916046">+91 7874916046</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> DearJob pvt Ltd.</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Sumit, Krunal and Rudra</a></li>
								</ul>
